...
class ApiTest {
    ...
    private static final String VALIDO =
            "{\"area\":\"AREA-001\",\"timestamp\":\"2026-09-04T15:30:00Z\",\"percentual_ocupado\":68.5,\"nivel_agua_m\":12.3,\"temperatura_agua_c\":22.5}";
    ...
    static Stream<Arguments> leituras() {
        return Stream.of(
                ...
                Arguments.of("medida como texto", VALIDO.replace("68.5", "\"68.5\""), 400, "percentual_ocupado"),
                Arguments.of("medida booleana", VALIDO.replace("68.5", "true"), 400, "percentual_ocupado"),
                Arguments.of("medida objeto", VALIDO.replace("68.5", "{}"), 400, "percentual_ocupado"),
                Arguments.of("medida enorme", VALIDO.replace("68.5", "1e999"), 400, "percentual_ocupado"),
                Arguments.of("identificador ausente", VALIDO.replace("\"area\":\"AREA-001\",", ""), 400, "area"),
                Arguments.of("identificador vazio", VALIDO.replace("AREA-001", "  "), 400, "area"),
                Arguments.of("identificador numérico", VALIDO.replace("\"AREA-001\"", "123"), 400, "area"),
                Arguments.of("identificador null", VALIDO.replace("\"AREA-001\"", "null"), 400, "area"),
                ...
                Arguments.of("objeto vazio", "{}", 400, "area"),
                ...
                Arguments.of("acima de 100", VALIDO.replace("68.5", "100.1"), 400, "percentual_ocupado")
        );
    }
