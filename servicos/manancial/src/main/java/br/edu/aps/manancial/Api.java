...
public class Api {
    public static final int PORTA=Integer.parseInt(Configuracao.valor("APS_PORT",Configuracao.valor("MANANCIAL_PORT","8081")));
    private static final String HOST=Configuracao.valor("APS_HOST","127.0.0.1");
    private static final String PREFIXO="/manancial";
    ...
    public static HttpServer criarServidor(int porta,Path arquivo) throws IOException {
        ...
        ThreadPoolExecutor executor=new ThreadPoolExecutor(32,32,0,TimeUnit.SECONDS,new ArrayBlockingQueue<>(256),r->{Thread t=new Thread(r,"http-manancial");t.setDaemon(true);return t;});
