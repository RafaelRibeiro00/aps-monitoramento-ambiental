...
URL_API = url_api("INVERSAO_TERMICA", 8083)
IDENTIFICADOR = obter("APS_IDENTIFICADOR", "ESTACAO-001")
...
def gerar_leitura():
    ...
    return {
        ...
        "umidade": round(random.uniform(0, 100), 2),
        "temperatura_c": round(random.uniform(-5, 40), 2),
        "vento_km_h": round(random.uniform(0, 60), 2),
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gera leituras aleatorias para a API inversao_termica.")
